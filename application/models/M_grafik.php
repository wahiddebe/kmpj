...
class M_grafik extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT barang_nama,SUM(barang_stok) AS tot_stok FROM tbl_barang JOIN tbl_kategori ON barang_kategori_id=kategori_id GROUP BY barang_nama");
