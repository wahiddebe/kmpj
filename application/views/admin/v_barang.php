                    ...
                    <form class="form-horizontal" method="post" action="<?php echo base_url() . 'admin/barang/tambah_barang' ?>">
                        ...
                        <div class="col-xs-9">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="harpok" class="harpok form-control" type="text" placeholder="Panjang Barang..." style="width:335px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="harjul" class="harjul form-control" type="text" placeholder="Lebar Barang..." style="width:335px;">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-9">
                                    <input name="harjul_grosir" class="harjul form-control" type="text" placeholder="Tinggi Barang..." style="width:335px;">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-xs-3">Volume</label>
                                <div class="col-xs-9">
                                    <input name="volu" class="harjul form-control" type="text" placeholder="Volume Barang..." style="width:335px;">
                                </div>
                            </div>
